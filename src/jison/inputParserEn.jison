...
[\u4e00-\u9fa5A-Za-z0123456789]            return 'INPUTTEXT'
...
expressions
    ...
    | predicate adverbial EOF
        { console.log({"type": "simple", "predicate": $1, "adverbial": $2, "conditions": undefined, "remain": $3});
          return {"type": "simple", "predicate": $1, "target": {"obj": {"type": "", "adj": [], "pos": @1.first_column, "end": @1.last_column}, "type": "single", "val": "loc"}, "adverbial": $2, "conditions": undefined, "remain": undefined}; }
...
value
    ...
    | object computableAttribute
        {$$ = {"obj": $1, "type": "single", "val": $2};}
