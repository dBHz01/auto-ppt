        ...
        for (let it of this.controller.elements.entries()) {
            ...
            switch (i.type) {
                ...
                case ElementType.ARROW:
                    ...
                    //     console.log(startCenter[0] + startWidth / 2);
                    //     console.log(endCenter[0] - endWidth / 2);
                    //     if (startCenter[0] + startWidth / 2 >= endCenter[0] - endWidth / 2) {
                    //         startCornerIndex = 0;
                    //     } else if (startCenter[1] - startHeight / 2 <= endCenter[1] + endHeight / 2) {
                    //         startCornerIndex = 2;
                    //     }
                    // } else if (startCornerIndex == 3) {
                    //     if (startCenter[0] + startWidth / 2 >= endCenter[0] - endWidth / 2) {
                    //         startCornerIndex = 4;
                    //     } else if (startCenter[1] + startHeight / 2 >= endCenter[1] - endHeight / 2) {
                    //         startCornerIndex = 2;
                    //     }
                    // } else if (startCornerIndex == 5) {
                    //     if (startCenter[0] - startWidth / 2 <= endCenter[0] + endWidth / 2) {
                    //         startCornerIndex = 4;
                    //     } else if (startCenter[1] + startHeight / 2 >= endCenter[1] - endHeight / 2) {
                    //         startCornerIndex = 6;
                    //     }
                    // } else if (startCornerIndex == 7) {
                    //     if (startCenter[0] - startWidth / 2 <= endCenter[0] + endWidth / 2) {
                    //         startCornerIndex = 0;
                    //     } else if (startCenter[1] - startHeight / 2 <= endCenter[1] + endHeight / 2) {
                    //         startCornerIndex = 6;
